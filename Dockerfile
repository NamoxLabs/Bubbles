...
# Build static
ADD ./bubbles/static /app/bubbles/static/
...
COPY --from=build-nodejs /app/bubbles/static /app/bubbles/static
...
RUN useradd --system bubbles && \
    mkdir -p /app/media /app/static && \
    chown -R bubbles:bubbles /app/
...
ENV PROCESSES 4
CMD ["uwsgi", "/app/bubbles/wsgi/uwsgi.ini"]
