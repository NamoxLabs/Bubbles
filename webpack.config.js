...
if (process.env.NODE_ENV === 'production') {
  ...
  output = {
    path: resolve('bubbles/static/assets/'),
...
var config = {
  entry: {
    dashboard: './bubbles/static/dashboard/js/dashboard.js',
    'dashboard-next': './bubbles/static/dashboard-next/index.tsx',
  },
  output: output,
  module: {
    rules: [
      ...
      },
      {
        ...
        include: [
          ...
          resolve('bubbles/static/fonts'),
          resolve('bubbles/static/images'),
          resolve('bubbles/static/dashboard/images')
        ]
      }
    ]
  },
